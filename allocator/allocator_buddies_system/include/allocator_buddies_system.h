...
private:
...

    {
        ...
        std::list<buddy_block>::iterator _it;

        std::list<buddy_block>::iterator _end;
    ...
    public:
        ...
        buddy_iterator(void* trusted_memory, std::list<buddy_block>::iterator it, std::list<buddy_block>::iterator end);
